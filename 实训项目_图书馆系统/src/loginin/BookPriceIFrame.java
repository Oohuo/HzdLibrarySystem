...
public class BookPriceIFrame extends JInternalFrame {
	...
	class ButtonAddListener implements ActionListener {
		...
		public void actionPerformed(final ActionEvent e) {
			...
			if (temp <= 0) {
				JOptionPane.showMessageDialog(null, "价格应该>=0");
				money.setText("");
				return;
			}
			...
			try {
				if (Dao.changePrice(re.getId(), re.getPrice())) {
